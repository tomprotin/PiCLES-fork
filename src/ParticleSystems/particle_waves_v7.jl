...
function particle_equations(u_wind, v_wind; γ::Number=0.88, q::Number=-1 / 4.0, IDConstants=IDConstants(),
    ...
    if static
        ...
        function particle_system(dz, z, params, t)#::MVector{5, Number}
            ...
            # lne, c̄_x, c̄_y, x, y, mat_1, mat_2, mat_3, mat_4, mat_5, mat_6, mat_7, mat_8, mat_9, mat_10 = z
            lne, c̄_x, c̄_y, x, y, matvec... = z
            covariance_mat = fold(matvec)
            r_g, C_α, C_e, C_φ = params.r_g, params.C_α, params.C_e, params.C_φ
            ...
            M = 
            dz[6:15] .= 0. # zero out the tendencies for the covariance matrix elements
